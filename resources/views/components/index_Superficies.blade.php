        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-g sm:px.20 bg-white border-b border-gray-200">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <button class="p-4">
                        <a href="{{ route('components.Superficies.create_Superficies') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium bg-black text-white rounded-md hover:bg-gray-800">
                            Crear Superficie
                        </a>
                    </button>
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <form action="{{ route('components.Superficies.destroy_Superficies', $superficie) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar el tenista {{$superficie->nombre}}?');">
                                    @csrf
                                    @method('DELETE')
